...
## Player
Players are also of significance to the game. The class Player is expected to realize all the actions that a real human can do. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA1OTE0NTY4MiwtNDM0NzE2ODQ5LDMzOT
