...
Meanwhile, we provide three lists: *SUITS*, *RANKS*, and *NUM* each of which contains respectively the index of *suit*, *rank* and *num*. Therefore, when we instanize the 3 inte
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI2Nzk2NDMxNCwtMTU1Mjg0MDE1MywtOT
